...
class CorrectedPortfolioSystemTester {
    constructor() {
        ...
        this.frontendUrl = 'http://${getFrontendPort()}';
        this.userServiceUrl = 'http://${getServiceUrl("userManagement")}';
        this.results = {
            services: {},
            authentication: {},
            portfolio: {},
    ...
    async testWebSocketConnections() {
        ...
        const wsEndpoints = [
            { name: 'terminal', url: 'ws://${getServiceUrl("terminal")}/ws' }, // Direct connection
            { name: 'portfolio', url: 'ws://${getServiceUrl("portfolio")}/ws' }  // Direct connection
        ];
    ...
    async measurePerformance() {
        ...
        const performanceTests = [
            ...
            { name: 'Portfolio Service Direct', url: `http://${getServiceUrl("portfolio")}/health` }
        ];
