    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div
              className={`h-full rounded-xl shadow-2xl flex flex-col overflow-hidden ${
                theme === "dark"
            ...
            >
              ...
              <div className="flex-1 overflow-hidden flex">
                {/* Line Numbers */}
                <div
                  className={`select-none px-4 py-4 text-right border-r overflow-y-hidden flex-shrink-0 ${
                    theme === "dark"
                ...
                >
                  {content.split("\n").map((_, index) => (
                    <div
                      key={index}
                      className="leading-6 hover:text-blue-500 transition-colors"
                    >
                      {index + 1}
                    </div>
                  ))}
