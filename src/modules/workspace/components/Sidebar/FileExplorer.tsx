...
const FileExplorer: React.FC<FileExplorerProps> = ({
      ...
      <div key={node.path}>
        ...
        >
          ...
          {isRenaming ? (
            ...
            <span
              className={`text-xs truncate ${theme === "dark" ? "text-gray-300" : "text-gray-700"}`}
            >
              {node.name}
            </span>
          )}
    ...
    return (
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          <div
            className={`animate-spin rounded-full h-8 w-8 border-b-2 ${theme === "dark" ? "border-blue-500" : "border-blue-600"} mx-auto`}
          ></div>
          <p
            className={`mt-2 text-xs ${theme === "dark" ? "text-gray-500" : "text-gray-600"}`}
          >
            Loading files...
          </p>
        </div>
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      {/* Search Bar */}
      <div
        className={`p-3 border-b flex-shrink-0 ${theme === "dark" ? "border-gray-700" : "border-gray-200"}`}
      >
      ...
      {/* Quick Actions */}
      <div
        className={`p-3 border-t flex-shrink-0 ${theme === "dark" ? "border-gray-700 bg-gray-800/50" : "border-gray-200 bg-gray-50"}`}
      >
