    ...
    >
      ...
      <div className="flex items-center space-x-4">
        ...
        <nav className="flex items-center space-x-1">
          <button className={`px-3 py-1.5 rounded-lg ${theme === 'dark' ? 'hover:bg-gray-700 text-gray-300' : 'hover:bg-gray-100 text-gray-700'} transition-colors text-sm font-medium`}>
            Projects
          </button>
          <button className={`px-3 py-1.5 rounded-lg ${theme === 'dark' ? 'hover:bg-gray-700 text-gray-300' : 'hover:bg-gray-100 text-gray-700'} transition-colors text-sm font-medium`}>
            Files
      ...
      <div className="flex-1 max-w-xl mx-4">
        ...
        >
          ...
          <div className="flex items-center space-x-1">
            <kbd className={`px-1.5 py-0.5 text-xs ${theme === 'dark' ? 'bg-gray-600' : 'bg-gray-200'} rounded`}>⌘</kbd>
            <kbd className={`px-1.5 py-0.5 text-xs ${theme === 'dark' ? 'bg-gray-600' : 'bg-gray-200'} rounded`}>K</kbd>
          </div>
        </button>
      </div>
      ...
      <div className="flex items-center space-x-2">
        ...
        <div className="ml-2 pl-2 border-l ${theme === 'dark' ? 'border-gray-700' : 'border-gray-200'}">
          <button className={`flex items-center space-x-2 px-3 py-1.5 rounded-lg ${theme === 'dark' ? 'hover:bg-gray-700' : 'hover:bg-gray-100'} transition-colors`}>
