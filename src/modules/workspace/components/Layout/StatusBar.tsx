  ...
  return (
    ...
    >
      ...
      <div className="flex items-center space-x-6">
        ...
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-1">
            ...
            <span
              className={`${cpuUsage > 50 ? "text-orange-500" : theme === "dark" ? "text-green-400" : "text-green-600"}`}
            >
              {cpuUsage}%
            </span>
          </div>
          <div className="flex items-center space-x-1">
            ...
            <span
              className={`${memoryUsage > 60 ? "text-orange-500" : theme === "dark" ? "text-blue-400" : "text-blue-600"}`}
            >
              {memoryUsage}%
            </span>
          </div>
      ...
      <div className="flex items-center space-x-4">
        {/* Notifications */}
        <button
          className={`flex items-center space-x-1 ${theme === "dark" ? "hover:text-gray-300" : "hover:text-gray-700"} transition-colors`}
        >
          <svg
            className="w-3 h-3"
            fill="none"
        ...
        {/* Time */}
        <span
          className={`${theme === "dark" ? "text-gray-400" : "text-gray-600"} font-mono`}
        >
