...
const XTermViewV2: React.FC<XTermViewV2Props> = ({
  ...
  useEffect(() => {
    ...
    if (xtermRef.current) {
      console.log(
        `[XTermView] Terminal already initialized for session ${sessionId}`,
      );
      return;
    }
    ...
    return () => {
      ...
      console.log(
        `[XTermView] Cleaning up terminal view for session: ${sessionId}`,
      );
        ...
        if (xtermRef.current) {
          switch (message.type) {
            ...
            case "suspended":
              ...
              console.log(
                `Terminal ${sessionId} suspended: ${message.message}`,
              );
            ...
            case "focusUpdate":
              ...
              console.log(
                `Terminal ${sessionId} focus update: ${message.focused}`,
              );
              break;
          }
        }
