...
async function testE2EIntegration() {
  ...
  try {
    ...
    console.log(`   • Portfolio Updates: ws://${getGatewayPort()}/ws/portfolio`);
    console.log(`   • Terminal: ws://${getGatewayPort()}/ws/terminal`);
    console.log(`   • AI Chat: ws://${getGatewayPort()}/ws/ai\n`);
