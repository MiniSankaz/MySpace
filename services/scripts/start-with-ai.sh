...
if ps -p $SERVER_PID > /dev/null; then
    ...
    echo -e "   ${CYAN}URL: http://localhost:$PORT_GATEWAY_MAIN/assistant${NC}"
else
...
echo -e "  • API Endpoint:  ${GREEN}http://localhost:$PORT_GATEWAY_MAIN/api/assistant${NC}"
echo -e "  • WebSocket:     ${GREEN}ws://localhost:$PORT_GATEWAY_MAIN/socket.io${NC}"
