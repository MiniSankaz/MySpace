...
class HealthAggregator {
  private services = {
    user: process.env.USER_SERVICE_URL || "http://localhost:4100",
    ai: process.env.AI_SERVICE_URL || "http://localhost:4200",
    terminal: process.env.TERMINAL_SERVICE_URL || "http://localhost:4300",
    workspace: process.env.WORKSPACE_SERVICE_URL || "http://localhost:4400",
    portfolio: process.env.PORTFOLIO_SERVICE_URL || "http://localhost:4500",
  };
