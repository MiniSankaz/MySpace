...
check_health "API Gateway" "http://localhost:4000/health" || true
check_health "User Management" "http://localhost:4100/health" || true
check_health "AI Assistant" "http://localhost:4200/health" || true
check_health "Terminal Service" "http://localhost:4300/health" || true
check_health "Workspace Service" "http://localhost:4400/health" || true
check_health "Portfolio Service" "http://localhost:4500/health" || true
