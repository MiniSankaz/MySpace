  ...
  apps: [
    ...
    // 2. API Gateway Service - Entry Point with Memory Optimization
    {
      ...
      env: {
        ...
        USER_SERVICE_URL: "http://${getServiceUrl("userManagement")}",
        AI_SERVICE_URL: "http://${getServiceUrl("aiAssistant")}",
        TERMINAL_SERVICE_URL: "http://${getServiceUrl("terminal")}",
        WORKSPACE_SERVICE_URL: "http://${getServiceUrl("workspace")}",
        PORTFOLIO_SERVICE_URL: "http://${getServiceUrl("portfolio")}",
