...
console.log('Expected behavior: Session should be killed when closed with code 1000\n');
...
function verifySessionKilled() {
  ...
  const ws2 = new WebSocket(`${WS_URL}?sessionId=${TEST_SESSION_ID}&projectId=${PROJECT_ID}`);
