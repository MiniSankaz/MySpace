...
async function clearLogs() {
  ...
  try {
    ...
    const terminalCommandPatterns = await prisma.terminalCommandPattern.deleteMany({});
    console.log(`  ✅ Deleted ${terminalCommandPatterns.count} command patterns`);
    ...
    console.log(`  ✅ Deleted ${assistantChatMessages.count} assistant chat messages`);

    const assistantConversations = await prisma.assistantConversation.deleteMany({});
    console.log(`  ✅ Deleted ${assistantConversations.count} assistant conversations`);
