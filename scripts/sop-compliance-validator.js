...
class SOPValidator {
  ...
  generateReport() {
    ...
    console.log(colors.bold(colors.cyan('     SOP Compliance Validation Report      ')));
    console.log(colors.bold(colors.cyan('═══════════════════════════════════════════\n')));
    ...
    ['CRITICAL', 'HIGH', 'MEDIUM', 'LOW'].forEach(severity => {
      ...
      shown.forEach(v => {
        ...
        if (v.context) {
          console.log(colors.gray(`  Context: ${v.context.substring(0, 60)}...`));
        }
      });
    ...
    const scoreColor = score >= 85 ? colors.green : 
                      score >= 60 ? colors.yellow : 
                      colors.red;
    
    console.log(colors.bold('Compliance Score: ') + colors.bold(scoreColor(`${score}/100`)));
