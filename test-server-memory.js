...
console.log(`  ⭐ Max Heap Size (heap_size_limit): ${toMB(heapStats.heap_size_limit)}MB`);
console.log(`  ⭐ This is ${(heapStats.heap_size_limit / 1024 / 1024 / 1024).toFixed(2)}GB\n`);
...
if (toMB(heapStats.heap_size_limit) >= 8000) {
  ...
  console.log(`  ❌ Current limit is only ${toMB(heapStats.heap_size_limit)}MB`);
}
